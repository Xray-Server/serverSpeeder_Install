...
URLKernel='https://raw.githubusercontent.com/Xray-Server/serverSpeeder_kernel/master/serverSpeeder.txt'
...
wget --no-check-certificate -q -O "/root/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "https://raw.githubusercontent.com/Xray-Server/serverSpeeder_kernel/master/$MyKernel"
...
wget --no-check-certificate -q -O "/appex/etc/apx.lic" "https://api.moeclub.org/lotServer?ver=0&mac=$MAC"
...
{
[ ! -f /root/appex.zip ] && wget --no-check-certificate -q -O "/root/appex.zip" "https://raw.githubusercontent.com/Xray-Server/serverSpeeser_Install/master/appex.zip"
